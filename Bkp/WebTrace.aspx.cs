	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!IsPostBack)
		{
			...
			else
			{
				...
				btnFields.OnClientClick = "VLewSession('" + Request.Url.PathAndQuery.ToLower().Replace("jump", "DuckCreek").Replace("webtrace.aspx", "sessionfield.aspx?sessionid='") + ", document.getElementBId('" + lstSessions.ClientID + "').value);";
