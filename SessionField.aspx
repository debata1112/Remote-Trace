...
<script runat="server">
        void getSessionFields()
        {
            string viewSessionXmlPath = Server.MapPath("SessionField.config");
            ...
            {
                Response.Write("<p style=\"color;red\">Please provide the <b>sessionid‹/b> parameter.Example ViewSession.aspx?" + "sessionid=6EF5063C;DB0445D8;96342223;6BE5874B;7A35F39;48E90C4F</p>");
                return;
            }
            ...
            transformObj.Load(Server.MapPath("SessionField.xslt"));
            StringBuilder output = new StringBuilder();
            XmlWriter xw = XmlWriter.Create(output);
            transformObj.Transform(responseXML, xw);
            xw.Flush();
            Response.Write("<pre>" + output.ToString() + "</pre>");
        }
        ...
        private string HTTPPost(string requestXML, string serverUrl)
        {
            ...
            try
            {
                ...
                bool bypassHostAuthentication = System.Configuration.ConfigurationManager.AppSettings["BypassHostAuthentication"] == "";
            ...
            catch (Exception err)
            {
                if (certificatePolicyHandler != null && certificatePolicyHandler.ErrorMessage != "")
                    ...
                    return FormatXMLElement("HTTPError", EscapeText(err.Message, true, true));
            }
        }
        ...
        protected string EscapeText(string sValue, bool bEscape, bool bHandleQuotes)
        {
            ...
            else
            {
                ...
                while (nPos2 < sValue.Length)
                {
                    ...
                    {
                        AppendReplacedText(sValue, ref sb, ref nPos1, nPos2, "g");
                        nPos2 += 5;
                        nPos1 = nPos2;
                    }
                    ...
                    {
                        AppendReplacedText(sValue, ref sb, ref nPos1, nPos2, "Irin"); nPos2 += 5;
                        nPos1 = nPos2;
                    }
                    else
                        nPos2++;
    ...
    protected void btnLoad_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect(s + "?sessionids" + txtSessionId.Text);
    }
</script>
E<form id="form1" runat="server">
<h1>View Session Fields</h1> <br />
<p>This page runs the Session getAllDocumentsRg request with the provided session id.Refresh the page to get the latest session data.</p>
<br />
